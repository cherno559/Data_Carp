...
def fig_heatmap(sim, rival, style_fn=None):
    ...
    # SOLUCIÓN DEFINITIVA PARA EL VALUEERROR DE PLOTLY:
    # Usamos sintaxis de "guión bajo" que nunca genera conflictos con diccionarios.
    fig.update_layout(
        font_family="Rajdhani",
        font_size=13,
        paper_bgcolor="rgba(0,0,0,0)",
        plot_bgcolor=LIGHT_B,
        title_text=f"MAPA DE MARCADORES — River vs {rival}",
        height=500,
        ...
        xaxis_tickfont_color="#374151",
        xaxis_gridcolor="#E5E7EB",
        xaxis_linecolor="#E5E7EB",
        xaxis_side="bottom",
        ...
        yaxis_tickfont_color="#374151",
        yaxis_gridcolor="#E5E7EB",
        yaxis_linecolor="#E5E7EB",
        hoverlabel_bgcolor="#111827",
        hoverlabel_bordercolor=RED,
        hoverlabel_font_color="white",
        hoverlabel_font_family="Rajdhani",
        hoverlabel_font_size=13
    )

    # Aplicamos el estilo del layout base sin romper las propiedades específicas
    if style_fn:
        try:
            style_fn(fig, title=f"MAPA DE MARCADORES — River vs {rival}")
        except:
            pass
