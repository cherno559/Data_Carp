...
# BUG FIX 5: Mapeo de abreviaturas de posición del Excel a texto legible
POSICION_MAP = {
...
def extraer_plantilla_river(ruta_excel_str):
    ...
    for hoja in xl.sheet_names:
        ...
        try:
            ...
            # BUG FIX 4: usar .get de Python en columnas con fallback correcto
    ...
    # BUG FIX 5: normalizar posición antes de agrupar
...
def simular_montecarlo(lam_r, lam_v):
    ...
    # Pequeño ajuste para penales (empates 1-0 o 0-1 pueden resolverse en penales)
...
def obtener_tabla_goleadores(titulares, df_plantilla, lam_r):
    ...
    # BUG FIX 5: usar posiciones normalizadas ("Delantero", "Mediocampista", etc.)
    def amenaza_base(pos):
        if "Delantero" in pos:
            return 0.05
        if "Mediocampista" in pos:
            return 0.03
        return 0.015
